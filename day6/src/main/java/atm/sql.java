package atm;
    ...
    CREATE TABLE xr_mall_db.account (
    ...
    CREATE TABLE xr_mall_db.transfer_order (
    ...
    COLLATE=utf8mb4_0900_ai_ci
            COMMENT='转账记录';
    CREATE INDEX transfer_order_order_id_IDX USING BTREE ON xr_mall_db.transfer_order (order_id);
